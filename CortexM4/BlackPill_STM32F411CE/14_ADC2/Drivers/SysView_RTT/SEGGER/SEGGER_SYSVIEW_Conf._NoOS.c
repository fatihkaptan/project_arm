...
#define SYSVIEW_APP_NAME        "NoOS Sampleproject2"
...
static void _cbSendSystemDesc(void) {
    SEGGER_SYSVIEW_SendSysDesc("N="SYSVIEW_APP_NAME",O=NoOS_Tasked,D="SYSVIEW_DEVICE_NAME);
    SEGGER_SYSVIEW_SendSysDesc("I#15=SysTick");
    SEGGER_SYSVIEW_NameMarker(1,"500ms hal delay test");
    SEGGER_SYSVIEW_NameMarker(2,"GPIO_LED_ON_Cmd");
    SEGGER_SYSVIEW_NameMarker(3,"GPIO_LED_OFF_Cmd");
    SEGGER_SYSVIEW_NameMarker(4,"adc_convert");
    SEGGER_SYSVIEW_NameMarker(5,"adc_convert_IT");
