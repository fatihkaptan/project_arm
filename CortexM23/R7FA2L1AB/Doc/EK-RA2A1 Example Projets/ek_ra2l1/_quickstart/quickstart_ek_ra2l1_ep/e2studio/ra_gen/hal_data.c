...
const timer_cfg_t g_gpt_blue_cfg =
		{ .mode = TIMER_MODE_PERIODIC,
				/* Actual period: 0.00020833333333333335 seconds. Actual duty: 50%. */.period_counts =
						(uint32_t) 0x2710, .duty_cycle_counts = 0x1388,
				.source_div = (timer_source_div_t) 0, .channel = 1,
				.p_callback = gpt_blue_callback,
    ...
    .p_context           = NULL,
				...
				.p_context = &NULL,
#endif
				.p_extend = &g_gpt_blue_extend, .cycle_end_ipl = (2),
...
const timer_instance_t g_gpt_blue = { .p_ctrl = &g_gpt_blue_ctrl, .p_cfg =
		&g_gpt_blue_cfg, .p_api = &g_timer_on_gpt };
adc_instance_ctrl_t g_adc_ctrl;
const adc_extended_cfg_t g_adc_cfg_extend = { .add_average_count = ADC_ADD_OFF,
...
const adc_cfg_t g_adc_cfg = { .unit = 0, .mode = ADC_MODE_CONTINUOUS_SCAN,
...
#endif
const adc_channel_cfg_t g_adc_channel_cfg = { .scan_mask = ADC_MASK_TEMPERATURE
...
/* Instance structure to use this module. */
const adc_instance_t g_adc = { .p_ctrl = &g_adc_ctrl, .p_cfg = &g_adc_cfg,
		.p_channel_cfg = &g_adc_channel_cfg, .p_api = &g_adc_on_adc };
gpt_instance_ctrl_t g_periodic_timer_ctrl;
#if 0
const gpt_extended_pwm_cfg_t g_periodic_timer_pwm_extend =
{
    .trough_ipl          = (BSP_IRQ_DISABLED),
...
#endif
const gpt_extended_cfg_t g_periodic_timer_extend =
		{
				.gtioca = { .output_enabled = false, .stop_level =
						GPT_PIN_LEVEL_LOW }, .gtiocb =
						{ .output_enabled = false, .stop_level =
    ...
    .capture_b_irq       = VECTOR_NUMBER_GPT0_CAPTURE_COMPARE_B,
				...
				.capture_filter_gtiocb = GPT_CAPTURE_FILTER_NONE,
#if 0
    .p_pwm_cfg                   = &g_periodic_timer_pwm_extend,
#else
				.p_pwm_cfg = NULL,
#endif
#if 0
...
const timer_cfg_t g_periodic_timer_cfg = { .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.000005 seconds. Actual duty: 50%. */.period_counts =
		(uint32_t) 0xf0, .duty_cycle_counts = 0x78, .source_div =
...
/** If NULL then do not add & */
    ...
    .p_context           = NULL,
		...
		.p_context = &NULL,
#endif
		.p_extend = &g_periodic_timer_extend, .cycle_end_ipl = (1),
...
/* Instance structure to use this module. */
const timer_instance_t g_periodic_timer = { .p_ctrl = &g_periodic_timer_ctrl,
		.p_cfg = &g_periodic_timer_cfg, .p_api = &g_timer_on_gpt };
