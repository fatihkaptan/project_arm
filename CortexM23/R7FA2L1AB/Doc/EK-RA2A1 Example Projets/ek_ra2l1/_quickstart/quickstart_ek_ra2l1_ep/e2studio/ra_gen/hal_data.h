...
#endif
/** Timer on GPT Instance. */
extern const timer_instance_t g_periodic_timer;

/** Access the GPT instance using these structures when calling API functions directly (::p_api is not used). */
extern gpt_instance_ctrl_t g_periodic_timer_ctrl;
extern const timer_cfg_t g_periodic_timer_cfg;
